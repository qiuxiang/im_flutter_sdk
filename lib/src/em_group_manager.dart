...
class EMGroupManager {
  ...
  final _groupChangeListeners = <EMGroupChangeListener>[];
  ...
  Future<EMGroup> muteAllMembers(String groupId) async {
    Map req = {'groupId': groupId};
  ...
  /// 取消对所有群成员禁言
  Future<EMGroup> unMuteAllMembers(String groupId) async {
    Map req = {'groupId': groupId};
